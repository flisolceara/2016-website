      ...
      <div class="container">
        ...
        <nav class="pull-right nav-collapse collapse">
          <ul id="menu-main" class="nav">
            ...
            <li><a title="Organização"  href="login.php">Organização</a></li>
          </ul>
        </nav>
      </div>
      <!-- /.container -->
    ...
    <div class="row">
      <div class="span10 offset1">
        ...
        <div class="featurette">
          <h2 class="featurette-heading">Quer palestrar, ministrar oficina ou mini-curso no FLISOL Ceará?</h2>
          <p>Inscreva-se como palestrante, envie sua apresentação ou material didático, e caso seja selecionado nós entraremos em contato com você.</p>
          <p>Inscreva-se <a title="contact" href="#contact">aqui.</a></p>
        </div>
        <!-- /.featurette -->
...
<section id="contact" class="single-page scrollblock">
    <div class="container">
        <div class="align"><i class="icon-mail"></i></div>
        <h1>Inscreva-se</h1>
        <div class="row">
            <div class="span12">
                    ...
                    <form id="form-inscrito" action="" method="post" class="cform-form">
                        <div class="row row-tipo">
                          <div class="span4">
                            ...
                            <div class="span8 class-radio">
                             <label>Você deseja ser inscrito como:</label>
                              <label class="span3">
                                  <input type="radio" name="categoria_id" value="1" checked="checked">
                                  <span class="tipo">1. Estudante</span>
                              </label>
                              <label class="span3">
                                  <input type="radio" name="categoria_id" value="2">
                                  <span class="tipo">2. Palestrante</span>
                              </label>
                            </div>
                        ...
                        <div class="row"> 
                            <div class="span6">
                                <span>
                                    <input type="text" name="instituicao"  placeholder="Instituição de ensino/ Empresa" class="cform-text" size="40" title="Instituição de ensino/ Empresa">
                                </span>
                            </div>
                            <div class="span6">
                                <span>
                                    <input type="text" name="semestre"  placeholder="Semestre / Tempo de trabalho" class="cform-text" size="40" title="Semestre / Tempo de trabalho">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="row"> 
                            <div class="span6">
                                <span>
                                    <input type="text" name="endereco"  placeholder="Endereço" class="cform-text" size="40" title="Endereço">
                                </span>
                            </div>
                            <div class="span6">
                                <span>
                                    <input type="text" name="telefone"   placeholder="Telefone" class="cform-text" size="40" title="Telefone">
                                </span>
                            </div>
                        </div>
                        <div class="row palestrante-itens"> 
                            <div class="span12">
                                <span>
                                    <input type="text" name="link"  placeholder="Link slide ou material didatico (Gdrive, Dropbox, etc)" class="cform-text" size="40" title="Arquivo">
                                </span>
                            </div>
                        </div>
                        <div class="row palestrante-itens"> 
...
$(document).ready(function() {
    ...
    // Traduzir mensagem de required (HTML5)
    ...
    $('input[type=radio][name=categoria_id]').change(function() {
        if (this.value == '2') {
            $('.palestrante-itens').show();
        } else {
          $('.palestrante-itens').hide();
        }
    });
